...
static async Task<CryptoResponseData?> FetchCryptoSumbols(HttpClient httpClient, long startTime)
{
...
static async Task<List<CryptoPriceRec>> FetchCryptoPrices(HttpClient httpClient, long startTime, CryptoResponseData? data)
{
...
static void SaveCryptoPrices(long startTime, List<CryptoPriceRec> cryptoPrices)
{
